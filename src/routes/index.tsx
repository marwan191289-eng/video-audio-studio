...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "محرر فيديو وصوت احترافي بمستوى CapCut وCanva — يعمل بالكامل في متصفحك.",
      },
    ],
  }),
  component: Index,
    ...
    <div className="min-h-screen bg-background text-foreground" dir="rtl">
      ...
      <header className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 border-b border-border/50 backdrop-blur-sm sticky top-0 z-50 bg-background/80">
        ...
        <nav className="hidden md:flex items-center gap-5 text-sm font-medium text-muted-foreground">
          <Link to="/enhance" className="hover:text-foreground transition">
            المحرر
          </Link>
          <Link to="/audio" className="hover:text-foreground transition">
            الصوت
          </Link>
          <Link to="/watermark" className="hover:text-foreground transition">
            العلامات المائية
          </Link>
          <Link to="/terminal" className="hover:text-foreground transition">
            التيرمنال
          </Link>
      ...
      <main className="mx-auto max-w-7xl px-6 pt-20 pb-32">
        ...
        <section className="text-center mb-24">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-muted-foreground text-lg leading-relaxed">
            كل ما تحتاجه في مكان واحد — تحسين الجودة، معالجة الصوت، نص على الفيديو، إزالة العلامات
            المائية، تغيير البصمة الرقمية، وتيرمنال FFmpeg متكامل. مثل CapCut وCanva لكن في متصفحك
            مباشرة.
          </p>
            ...
            >
              ...
              <div className="relative">
                <div className="flex items-start justify-between mb-4">
                  <div
                    className={`inline-flex rounded-2xl bg-gradient-to-br ${f.gradient} p-3.5 shadow-lg`}
                  >
                ...
                <h3 className="font-black text-lg mb-2 group-hover:text-violet-400 transition">
                  {f.title}
                </h3>
        ...
        <section className="rounded-3xl border border-border bg-card/30 p-10 text-center backdrop-blur-sm">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            يستخدم هذا التطبيق تقنية <strong className="text-foreground">FFmpeg.wasm</strong>{" "}
            لمعالجة الوسائط مباشرةً في المتصفح دون رفع أي ملف لخوادم خارجية. بياناتك تبقى على جهازك
            دائماً — خصوصية تامة وسرعة فائقة.
          </p>
